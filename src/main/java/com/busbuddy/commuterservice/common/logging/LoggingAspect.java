package com.busbuddy.commuterservice.common.logging;
...
public class LoggingAspect {
    ...
    @AfterThrowing(value = "execution(* com.busbuddy.commuterservice..*(..))", throwing = "ex")
